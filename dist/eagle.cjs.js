...
var __vue_render__$1 = function() {
  ...
  return _c(
    ...
    {
      attrs: {
        "enter-active-class": _vm.enter
          ? "animate animate__animated " + _vm.enter
          : "",
        "leave-active-class": _vm.leave
          ? "animate animate__animated " + _vm.leave
          : ""
      }
    },
    [_vm._t("default")],
...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-6e9c40e1_0", { source: "\n.eg-modal {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n", map: {"version":3,"sources":["/home/brill/Workspace/github.com/agaengel/eagle.js/src/components/widgets/Modal.vue"],"names":[],"mappings":";AAcA;EACA,kBAAA;EACA,MAAA;EACA,OAAA;EACA,WAAA;EACA,YAAA;AACA","file":"Modal.vue","sourcesContent":["<template lang='pug'>\n.eg-modal\n  .content\n    slot\n</template>\n\n<script>\nexport default {\n  isWidget: true,\n  name: 'eg-modal'\n}\n</script>\n\n<style>\n.eg-modal {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n</style>\n"]}, media: undefined });
...
__vue_render__$3._withStripped = true;
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-74e614a8_0", { source: ".eg-code-block.container[data-v-74e614a8] {\n  position: relative;\n  width: 100%;\n}\n.eg-code-block .code-box .eg-code-comment[data-v-74e614a8] {\n  display: none;\n}\n.eg-code-block .comments-box[data-v-74e614a8] {\n  position: absolute;\n  color: rgba(0, 0, 0, 0);\n  top: 0;\n}\n.eg-code-block .eg-code-comment[data-v-74e614a8] {\n  z-index: 10 !important;\n}\n\n/*# sourceMappingURL=CodeBlock.vue.map */", map: {"version":3,"sources":["/home/brill/Workspace/github.com/agaengel/eagle.js/src/components/widgets/CodeBlock.vue","CodeBlock.vue"],"names":[],"mappings":"AAgDA;EACA,kBAAA;EACA,WAAA;AC/CA;ADmDA;EACA,aAAA;ACjDA;ADqDA;EACA,kBAAA;EACA,uBAAA;EACA,MAAA;ACnDA;ADuDA;EACA,sBAAA;ACrDA;;AAEA,wCAAwC","file":"CodeBlock.vue","sourcesContent":["<template lang='pug'>\n.eg-code-block.container\n  .box.hljs.code-box(:id='id')\n    pre\n      code(:class=\"lang ? lang : ''\", :id='id3')\n  .box.comments-box\n    pre\n      code(:id='id2')\n        slot\n</template>\n\n<script>\nimport { Options } from '../../main.js'\n\nfunction randId () {\n  return Math.random().toString(36).substr(2, 10)\n}\n\nexport default {\n  isWidget: true,\n  name: 'eg-code-block',\n  props: {\n    id: {default: () => randId()},\n    id2: {default: () => randId()},\n    id3: {default: () => randId()},\n    lang: {default: null}\n  },\n  mounted: function () {\n    this.update()\n  },\n  updated: function () {\n    this.update()\n  },\n  methods: {\n    update: function () {\n      var codeBlock = document.getElementById(this.id)\n      var commentsContent = document.getElementById(this.id2)\n      var codeContent = document.getElementById(this.id3)\n      codeContent.innerHTML = commentsContent.innerHTML\n      if (this.lang && Options.hljs) {\n        Options.hljs.highlightBlock(codeBlock)\n      }\n    }\n  }\n}\n</script>\n<style lang='scss' scoped>\n.eg-code-block {\n  &.container {\n    position: relative;\n    width: 100%;\n  }\n\n  .code-box {\n    .eg-code-comment {\n      display: none\n    }\n  }\n\n  .comments-box {\n    position: absolute;\n    color: rgba(0, 0, 0, 0.0);\n    top: 0;\n\n  }\n\n  .eg-code-comment {\n    z-index: 10 !important;\n  }\n}\n</style>\n",".eg-code-block.container {\n  position: relative;\n  width: 100%;\n}\n.eg-code-block .code-box .eg-code-comment {\n  display: none;\n}\n.eg-code-block .comments-box {\n  position: absolute;\n  color: rgba(0, 0, 0, 0);\n  top: 0;\n}\n.eg-code-block .eg-code-comment {\n  z-index: 10 !important;\n}\n\n/*# sourceMappingURL=CodeBlock.vue.map */"]}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$4 = "data-v-74e614a8";
  /* module identifier */
...
__vue_render__$4._withStripped = true;
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-72910a9d_0", { source: "\n.eg-code-comment {\n  display: inline-block\n}\n", map: {"version":3,"sources":["/home/brill/Workspace/github.com/agaengel/eagle.js/src/components/widgets/CodeComment.vue"],"names":[],"mappings":";AAmBA;EACA;AACA","file":"CodeComment.vue","sourcesContent":["<template lang='pug'>\neg-transition(:enter='enter', :leave='leave')\n  div.eg-code-comment(v-if='active')\n    span(v-if='arrow') &larr;\n    slot\n</template>\n<script>\nexport default {\n  isWidget: true,\n  name: 'eg-code-comment',\n  props: {\n    enter: {default: null},\n    leave: {default: null},\n    active: {default: true},\n    arrow: {default: true}\n  }\n}\n</script>\n<style>\n.eg-code-comment {\n  display: inline-block\n}\n</style>\n"]}, media: undefined });
...
__vue_render__$9._withStripped = true;
  ...
  const __vue_inject_styles__$a = function (inject) {
    if (!inject) return
    inject("data-v-6e2ca9fb_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Timer.vue"}, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$a = "data-v-6e2ca9fb";
  /* module identifier */
